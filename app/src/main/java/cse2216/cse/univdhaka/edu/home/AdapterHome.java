...
public class AdapterHome extends ArrayAdapter<foodPrice>{
        private List<foodPrice> list;
        Context context;
        private LayoutInflater inflater;

        AdapterHome(Context context, List<foodPrice> list){
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            if(convertView==null){
                ...
                convertView = inflater.inflate(R.layout.home_sample_layout,parent,false);
            }
